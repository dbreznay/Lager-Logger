...
const SomeonexFreeSpot = (props) =>{
	return (
		<div className="playerDetails__wrapper">
			...
			<p>
			So far no player has logged in to occupy this position. The administrator of this room can add a bot to occupy this position.
			</p>
			<Buttons>
				<CloseButton {...props}/>
...
const SomeonexSomeone = (props) => {
	...
	return (
		<div className="playerDetails__wrapper">
			...
			<p>
				{props.player.get('name')} this <font color="green">connected </font> 
				to this room there {t} minutes and <b> 
				{props.player.get('isBot') ? `` : `não`} it's a bot.</b>
			</p>
			{props.lookAtAdmin && (<p>
				{props.player.get('name')} is the administrator of this room,
				as such, he can add bots to this room.
			</p>)}
